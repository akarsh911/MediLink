  ...
  return (
    <div className='container biography'>
        ...
        <div className='banner'>
            <p>Biography</p>
            <h3>Who we are</h3>
            <p>At Meddling Hospital, we stand as a beacon of healthcare excellence, committed to delivering compassionate care and cutting-edge medical services to our community and beyond.</p>
